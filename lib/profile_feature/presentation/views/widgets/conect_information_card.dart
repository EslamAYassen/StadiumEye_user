        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: Text('john.smith@company.com',style: TextStyle(fontSize: 15),),
            ...
            ListTile(
              ...
              subtitle: Text('+1 (555) 123-4567',style: TextStyle(fontSize: 15)),
              visualDensity: VisualDensity(vertical: -3),
            ),
            ListTile(
              contentPadding: EdgeInsets.zero,
              ...
              subtitle: Text('San Francisco, CA',style: TextStyle(fontSize: 15)),
              visualDensity: VisualDensity(vertical: -3),
            ),
          ],
        ),
